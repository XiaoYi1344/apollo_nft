...
//   Paper,
// } from '@mui/material';
// import { useCategories, useOwnedNews, useCreateNews } from '@/hooks/useNews';
...
//   const { data: ownedNews, isLoading: newsLoading } = useOwnedNews();
...
//   // --- Stats ---
//   const totalNews = ownedNews?.length || 0;
//   const publishedNews =
//     ownedNews?.filter((n) => n.status === 'published').length || 0;
//   const draftNews = ownedNews?.filter((n) => n.status === 'draft').length || 0;
//   const totalViews =
//     ownedNews?.reduce((sum, n) => sum + (n.views || 0), 0) || 0;
