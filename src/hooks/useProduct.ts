...
//   if (
//     'totalInstock' in p &&
//     typeof (p as OwnedProduct).totalInstock === 'number'
//   ) {
...
// // Lấy product từ cả marketplace + owned
// export const useProduct = (id: number) =>
...
//         queryKey: ['product', Number(variables.id)],
//       });
//       queryClient.invalidateQueries({ queryKey: ['products'] });
//       queryClient.invalidateQueries({ queryKey: ['ownedProducts'] });
//     },
...
// // export const useProductsByCollection = (collectionId: number, enabled = true) =>
// //   useQuery<OwnedProduct[]>({
// //     queryKey: ['productsByCollection', collectionId],
// //     queryFn: async () => {
// //       const products =
// //         await productService.getProductsByCollection(collectionId);
...
//     onSuccess: () => {
//       // Làm mới dữ liệu sản phẩm và sản phẩm đã sở hữu
//       queryClient.invalidateQueries({ queryKey: ['products'] });
//       queryClient.invalidateQueries({ queryKey: ['ownedProducts'] });
//     },
//   });
...
//       if (
//         selectedStatuses.includes('Buy Now') ||
//         selectedStatuses.includes('Has Offers')
//       ) {
